#=This file will contain the computations of the greens function of the interacting graphene tight binding model.

    The correlator will be computed through monte carlo techniques and compared for small interactions to the non-interacting 
    analytical solution. 
=#
